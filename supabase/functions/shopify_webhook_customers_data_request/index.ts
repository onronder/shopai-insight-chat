// File: /supabase/functions/shopify_webhook_customers_data_request/index.ts
...
const context = "shopify_webhook_customers_data_request";
...
serve(async (req) => {
  ...
  try {
    ...
    logInfo(context, "Received customer data request", { customerId, shopDomain });
