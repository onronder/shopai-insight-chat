// File: /supabase/functions/shopify_webhook_shop_redact/index.ts
...
const context = "shopify_webhook_shop_redact";
...
serve(async (req) => {
  ...
  try {
    ...
    logInfo(context, "Received shop data erasure request", { shopDomain });

    // ⚡ OPTIONAL: In the future, delete shop-specific records from your database if you store any.
